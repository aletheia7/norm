...
int main(int argc, char* argv[])
{
    ...
    while (keepGoing)
    {
        ...
        //  We could do this by adding a "bytes_written" variable to the ClientInfo
        //  and not read more input until _all_ clients have been sent the full
        //  current "inputLength".)  But, for the moment, the unicast "normServer" only 
        // sends to the "firstClientSocket"
