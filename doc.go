...
/*
Package norm is a cgo wrapper for NACK-Oriented Reliable Multicast (NORM).
libnorm and the NORM protocal provide reliable UDP over multicast and unicast
sockets. libnorm can replace TCP/IP, and in many use cases, provide greater
performance.
